(* CSE341 Winter 2013, Homework 7, hw7.sml (see also Ruby code) *)
...
fun intersect (v1,v2) =
    case (v1,v2) of
      ...
      | (LineSegment seg, _) => (* the complicate case*)
    ...
    case e of
      ...
      | Shift(deltaX, deltaY, exp) =>
        case eval_prog(exp,env) of
          ...
          | _ => raise Impossible "impossible type for Shift"
