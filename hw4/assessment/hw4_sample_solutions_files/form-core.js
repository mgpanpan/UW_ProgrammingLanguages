...
<script type="text/javascript">
  window.Global = {
    ...
    SITES_ASSETS_BASE_URL: 'https://dw0ugk4msqulk.cloudfront.net/0f333b0c001b86c04b5eb058f644459716d4a36d/',
...
<!--[if !IE]> --><script>document.getElementById("coursera-loading-js").style.display = 'block';</script><!-- <![endif]--><script>if (/zh/i.test(window.localStorage ? localStorage.getItem('locale') : '') || '{{ locale }}') {
  document.getElementById('get-browser-zh').style.display = 'block';
    ...
    <script src='https://dw0ugk4msqulk.cloudfront.net/0f333b0c001b86c04b5eb058f644459716d4a36d/pages/hg/thirdparty/webshims/extras/modernizr-custom.js' ></script>
  <script src="https://dw0ugk4msqulk.cloudfront.net/0f333b0c001b86c04b5eb058f644459716d4a36d/js/vendor/require.v2-1-1.js"></script><script data-baseurl="https://dw0ugk4msqulk.cloudfront.net/0f333b0c001b86c04b5eb058f644459716d4a36d/" data-version="0f333b0c001b86c04b5eb058f644459716d4a36d" data-timestamp='1416026630903' data-debug='0' data-locale="en" id="_require">if(document.getElementById('coursera-loading-js').style.display == 'block') {
  (function(el) {
     require.config({
       //enforceDefine: true,
       waitSeconds: 75,
